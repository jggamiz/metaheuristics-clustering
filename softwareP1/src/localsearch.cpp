...
ResultMH<int> LocalSearch::optimize(Problem<int>& problem, int maxevals) {
    ...
    // 1. Generar Solución Inicial Aleatoria (Asegurando clústeres no vacíos)
    ...
    // 2. Bucle principal de la Búsqueda Local
    while (improvement && evaluations < (unsigned int)maxevals) {
        ...
        // 3. Explorar el vecindario (Estrategia "Primer Mejor")
