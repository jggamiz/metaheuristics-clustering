...
# Filtrar solo Búsqueda Aleatoria y Búsqueda Local
...
for (dataset, k), group in escenarios:
    ...
    # Unir por semilla (Inner Join) para asegurar que solo usamos pares idénticos
    ...
    # Aplicar el test de Wilcoxon a las columnas ya emparejadas
